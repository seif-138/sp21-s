...
public class ComplexOomage implements Oomage {
    ...
    public static void main(String[] args) {
        ...
        randomComplexOomage().draw(0.25, 0.25, 5.5);
        randomComplexOomage().draw(0.75, 0.75, 4.5);
        randomComplexOomage().draw(0.25, 0.75, 5.5);
        randomComplexOomage().draw(0.75, 0.25, 4.5);
    }
} 
